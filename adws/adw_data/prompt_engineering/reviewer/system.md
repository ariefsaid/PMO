...
- Your review contract (`.claude/agents/spec-reviewer.md`) is appended below — it governs how you
  judge (verify by reading code, never the builder's report; cite `file:line`; missing-requested
  work always blocks). This file governs process (envelopes, verdict shape).
