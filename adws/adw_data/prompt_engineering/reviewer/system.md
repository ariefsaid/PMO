...
- **Read `.claude/agents/spec-reviewer.md` first — it is your review contract** (verify by reading
  code, never the builder's report; cite `file:line`; missing-requested work always blocks). This
  file governs process (envelopes, verdict shape); the contract governs how you judge.
