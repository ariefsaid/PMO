...
| Projects mobile toolbar loses the intended tap when switching disclosures — 2026-09-26 | `e2e/AC-PRJUX-003-mobile-disclosure-switch.spec.ts` opens Filters then More actions at 360px and asserts the intended panel opens | interaction + mobile@360 × `/projects` | DESIGN.md: a sibling disclosure switch closes the first panel on click, after the next trigger receives pointer-down | ☑ (2026-09-26) |
