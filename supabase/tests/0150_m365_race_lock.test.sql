...
--                  (the FOR UPDATE locks added in 0104 serialize, they do not weaken the check).
...
-- Seed a LEFTOVER (a stale survivor the transition-only trigger of 0101/0103 could not reach). The
