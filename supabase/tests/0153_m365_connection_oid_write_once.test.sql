...
-- AC-M365-174 [pgTAP]: the entra_user_object_id WRITE-ONCE column trigger (0117) — the structural
...
--
-- Runs as pgTAP superuser (triggers fire regardless of role). The write-guard (0113) also fires on
