...
insert into projects (id, org_id, code, name, status, contract_value, tax_treatment, tax_amount) values
  ('01300000-0000-0000-0000-000000000010','01300000-0000-0000-0000-000000000001',
   'PRJ-LEGACY','Legacy Project (no import)','Ongoing Project', 1000, 'exclusive', 0);
...
insert into projects
  (id, org_id, code, name, status, contract_value, tax_treatment, tax_amount, import_key, import_batch_id, imported_at)
values
  ('01300000-0000-0000-0000-000000000011','01300000-0000-0000-0000-000000000001',
   'PRJ-B5','Imported Project','Close Out', 120000, 'exclusive', 0,
...
select throws_ok(
  $$insert into projects
      (org_id, code, name, status, contract_value, tax_treatment, tax_amount, import_key, import_batch_id, imported_at)
    values
      ('01300000-0000-0000-0000-000000000001','PRJ-B5-DUP','Dup Imported Project','Close Out', 120000, 'exclusive', 0,
       'PRJ-B5','01300000-0000-0000-0000-00000000ba01', now())$$,
  '23505',
  null,
