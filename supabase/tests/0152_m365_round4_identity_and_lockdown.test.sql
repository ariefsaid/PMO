...
--                  ms_graph_connections (the 0115/0116 RPCs are the only mutation path), SELECT is
...
-- service_role may NOT directly INSERT/UPDATE/DELETE ms_graph_connections (0116 revoked them); the
-- 0115/0116 SECURITY-DEFINER RPCs are the only mutation path. SELECT is retained.
