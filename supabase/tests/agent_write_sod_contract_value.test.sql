...
--
-- Uses unique UUID namespace 00AD0011-… to avoid collisions.
begin;
select plan(2);

-- ── Fixtures ────────────────────────────────────────────────────────────────
insert into organizations (id, name) values
  ('00ad0011-0000-0000-0000-000000000001','AW-011 Org A');

insert into auth.users (id, email) values
  ('00ad0011-0000-0000-0000-0000000000a1','aw011-pm@example.com');

insert into profiles (id, org_id, full_name, email, role) values
  ('00ad0011-0000-0000-0000-0000000000a1','00ad0011-0000-0000-0000-000000000001',
...
set local request.jwt.claims = '{"sub":"00ad0011-0000-0000-0000-0000000000a1","role":"authenticated"}';

select throws_ok(
  $$ update projects set contract_value = 9999999
       where id = '00ad0011-0000-0000-0000-000000000010' $$,
  '42501', null,
...
select is(
  (select contract_value from projects where id = '00ad0011-0000-0000-0000-000000000010'),
  1000000::numeric,
