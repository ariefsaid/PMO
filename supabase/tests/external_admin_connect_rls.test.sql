...
-- `has_function_privilege('service_role', 'public.log_audit(...)', 'EXECUTE')` = true even with 0122's
...
-- Test 82: Partial unique index (0122) permits re-linking the same container after unlink (tombstone does not block)
