-- 0153_command_held_fenced_on_release.test.sql
...
insert into organizations (id, name) values
  ('01530000-0000-0000-0000-00000000000a','Fenced Held Org');

insert into auth.users (id, email) values
  ('01530000-0000-0000-0000-0000000000a1','fence-admin@example.com'),
  ('01530000-0000-0000-0000-0000000000a2','fence-owner@example.com');

insert into profiles (id, org_id, full_name, email, role, manager_id) values
  ('01530000-0000-0000-0000-0000000000a1','01530000-0000-0000-0000-00000000000a',
   'Admin F','fence-admin@example.com','Admin', null),
  ('01530000-0000-0000-0000-0000000000a2','01530000-0000-0000-0000-00000000000a',
   'Owner F','fence-owner@example.com','Engineer','01530000-0000-0000-0000-0000000000a1');
...
insert into timesheets (id, org_id, user_id, week_start_date, status, approved_by, approved_at) values
  ('01530000-0000-0000-0000-0000000000a0','01530000-0000-0000-0000-00000000000a',
   '01530000-0000-0000-0000-0000000000a2','2026-06-01','Approved','01530000-0000-0000-0000-0000000000a1', now()),
  ('01530000-0000-0000-0000-0000000000b0','01530000-0000-0000-0000-00000000000a',
   '01530000-0000-0000-0000-0000000000a2','2026-06-08','Approved','01530000-0000-0000-0000-0000000000a1', now());
...
insert into pg_temp.ids values
  ('race',    pg_temp.seed_held_command('01530000-0000-0000-0000-0000000000a0')),
  ('control', pg_temp.seed_held_command('01530000-0000-0000-0000-0000000000b0'));
...
select is(
  (select count(*)::int from timesheet_erp_mirror where timesheet_id = '01530000-0000-0000-0000-0000000000a0'),
  0,
...
set local request.jwt.claims = '{"sub":"01530000-0000-0000-0000-0000000000a1","role":"authenticated"}';
...
select record_timesheet_command_held(
  '01530000-0000-0000-0000-00000000000a',
  '01530000-0000-0000-0000-0000000000a0',
  now(),
...
select is(
  (select push_state from timesheet_erp_mirror where timesheet_id = '01530000-0000-0000-0000-0000000000a0'),
  'failed',
...
select record_timesheet_command_held(
  '01530000-0000-0000-0000-00000000000a',
  '01530000-0000-0000-0000-0000000000b0',
  now(),
  'command-held: the recovery probe failed deterministically');

select is(
  (select push_state from timesheet_erp_mirror where timesheet_id = '01530000-0000-0000-0000-0000000000b0'),
  'held',
