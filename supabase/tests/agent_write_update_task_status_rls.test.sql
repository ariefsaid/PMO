...
insert into auth.users (id, email) values
  ('00aw0010-0000-0000-0000-0000000000b1','aw010-eng-b@example.com'),
  ('00aw0010-0000-0000-0000-0000000000b2','aw010-eng-b2@example.com');

insert into profiles (id, org_id, full_name, email, role) values
  ('00aw0010-0000-0000-0000-0000000000b1','00000000-0000-0000-0000-000000000001',
   'AW010 Eng B','aw010-eng-b@example.com','Engineer'),
  ('00aw0010-0000-0000-0000-0000000000b2','00000000-0000-0000-0000-000000000001',
   'AW010 Eng B2','aw010-eng-b2@example.com','Engineer');

insert into projects (id, org_id, code, name, status) values
  ('00aw0010-0000-0000-0000-000000000010','00000000-0000-0000-0000-000000000001',
...
insert into tasks (id, org_id, project_id, name, status, assignee_id) values
  ('00aw0010-0000-0000-0000-000000000021','00000000-0000-0000-0000-000000000001',
   '00aw0010-0000-0000-0000-000000000010','AW010 Task 1','To Do',
   '00aw0010-0000-0000-0000-0000000000b1'),
  ('00aw0010-0000-0000-0000-000000000022','00000000-0000-0000-0000-000000000001',
   '00aw0010-0000-0000-0000-000000000010','AW010 Task 2','To Do',
   '00aw0010-0000-0000-0000-0000000000b2');
...
set local request.jwt.claims = '{"sub":"00aw0010-0000-0000-0000-0000000000b1","role":"authenticated"}';

select lives_ok(
  $$ update tasks set status = 'Done' where id = '00aw0010-0000-0000-0000-000000000021' $$,
...
select lives_ok(
  $$ update tasks set status = 'Done' where id = '00aw0010-0000-0000-0000-000000000022' $$,
...
select is(
  (select status::text from tasks where id = '00aw0010-0000-0000-0000-000000000021'),
  'Done',
  'AC-AW-010-a: T1 status persisted to Done (own-task update succeeded)');

select is(
  (select status::text from tasks where id = '00aw0010-0000-0000-0000-000000000022'),
  'To Do',
