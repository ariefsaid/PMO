...
select is(public.finalize_external_connect('a1470000-0000-0000-0000-000000000001','clickup','a147_secret',true,false,'a1470000-0000-0000-0000-0000000000a1'), 'rejected', 'AC-IEM-003 finalize rejects failed readiness');
