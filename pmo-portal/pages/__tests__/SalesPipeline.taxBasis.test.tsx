...
describe('OD-TAX-1 §2: the pipeline table states each deal’s own tax basis (#578)', () => {
  it('labels an inclusive row and an exclusive row from the rows themselves', () => {
    renderPage();
  ...
  it('renders no basis where the row holds none, rather than falling back to the org default', () => {
    renderPage();
