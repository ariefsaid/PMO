...
// Re-export HydratedPrimitive so any relative importers/tests using UserViewRenderer
// as the import source continue to resolve without breakage (FR-CV-013 D5).
export { HydratedPrimitive };
