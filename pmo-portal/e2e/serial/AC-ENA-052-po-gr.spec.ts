...
if (FUNCTIONS_URL && !READY) {
  throw new Error('AC-ENA-052-po-gr: SUPABASE_FUNCTIONS_URL + SUPABASE_URL + VITE_SUPABASE_ANON_KEY are required once the served lane is up (SUPABASE_FUNCTIONS_URL set) — never a silent skip');
}
