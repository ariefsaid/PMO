...
/**
 * One icon family, one stroke width (2). Ported verbatim from the IA-3 mockup's
 * `ICONS` map — SVG only, no emoji. All icons share a 24×24 viewBox and inherit
 * `currentColor`, so color comes from the consuming token utility.
 *
 * Usage: `<Icon name="grid" className="size-4" />` or the `ICON_PATHS` map for
 * data-driven rendering (tab strip, command palette).
 */
