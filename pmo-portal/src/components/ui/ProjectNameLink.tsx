...
/**
 * The ONE click-to-open affordance for a linked project name (ADR-0028, census violation E).
 *
 ...
 *
 * When `projectId` is null/undefined OR `name` is null/undefined: renders
 * inert `<span>` with em-dash fallback (no navigation affordance).
 */
