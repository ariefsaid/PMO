...
const KANBAN_PROJECTS: PipelineProject[] = [
  { id: 'a1', name: 'Alpha', client_name: 'A', status: 'Leads', contract_value: 100_000, currency: 'USD', tax_treatment: 'exclusive', win_probability: 0.1 },
  { id: 'b1', name: 'Bravo', client_name: 'B', status: 'Tender Submitted', contract_value: 200_000, currency: 'USD', tax_treatment: 'inclusive', win_probability: 0.5 },
];
