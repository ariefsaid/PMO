...
/**
 * The list-endpoint fields `mrFromDoc` actually READS (Luna BLOCK 6). The modified-poll sweep builds its
 ...
 */
export const MR_FROM_DOC_FIELDS = ['name', 'modified', 'docstatus', 'amended_from', 'total'] as const;
